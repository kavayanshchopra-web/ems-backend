 ...
 * 100% Schema-Driven Card Renderer with Full Unconditional Details & Candidate ID
 */
...
export default function KanbanCard({
  ...
  return (
    ...
    >
      {/* 1. HEADER: ID BADGE + TITLE + VIEW EYE BUTTON */}
      ...
      {/* 4. FOOTER ACTIONS & STAGE MOVER DROPDOWN */}
