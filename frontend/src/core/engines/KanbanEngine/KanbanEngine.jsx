 ...
 * Fixed 340px Columns, Single Horizontal Row, Native Overflow-X Scrolling
 */
...
export default function KanbanEngine({
  ...
  // Shift + Mouse Wheel scrolling ONLY (Normal wheel scrolls page vertically natively!)
  const handleWheel = (e) => {
  ...
  // Click-and-Drag on Kanban Background ONLY (Ignores cards, buttons, selects)
