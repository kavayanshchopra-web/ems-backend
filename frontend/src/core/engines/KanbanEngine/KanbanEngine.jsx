 ...
 * 100% Schema-Driven Kanban Board for any EMS Module
 */
  ...
  return (
    ...
    >
      <div
        style={{
          display: 'grid',
          gridTemplateColumns: `repeat(${Math.max(1, autoGeneratedColumns.length)}, minmax(280px, 1fr))`,
          gap: '16px',
          alignItems: 'start',
          minWidth: autoGeneratedColumns.length > 4 ? `${autoGeneratedColumns.length * 290}px` : '100%'
        }}
      >
