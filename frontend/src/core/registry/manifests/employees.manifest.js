...
export const EMPLOYEES_MANIFEST = {
  ...
  defaultFields: [
    ...
    { id: 'role', key: 'role', label: 'System Role', type: 'dropdown', options: ['Owner / Admin', 'Manager', 'Sales Agent', 'Staff Employee'], systemField: true, required: true, searchable: true, filterable: true, sortable: true, showOnCreate: true, showOnEdit: true, showOnView: true, showOnList: true, showOnKanban: true, sortOrder: 2 },
    { id: 'department', key: 'department', label: 'Department', type: 'dropdown', options: ['Sales', 'Engineering', 'Marketing', 'HR', 'Finance', 'Operations'], systemField: true, required: true, searchable: true, filterable: true, sortable: true, showOnCreate: true, showOnEdit: true, showOnView: true, showOnList: true, showOnKanban: true, sortOrder: 3 },
    { id: 'designation', key: 'designation', label: 'Designation', type: 'text', systemField: true, required: false, searchable: true, filterable: true, sortable: true, showOnCreate: true, showOnEdit: true, showOnView: true, showOnList: true, showOnKanban: true, placeholder: 'e.g. Senior Account Manager', sortOrder: 4 },
    ...
    { id: 'status', key: 'status', label: 'Employment Status', type: 'dropdown', options: ['Active', 'On Leave', 'Suspended', 'Terminated'], systemField: true, required: true, searchable: true, filterable: true, sortable: true, showOnCreate: true, showOnEdit: true, showOnView: true, showOnList: true, showOnKanban: true, defaultValue: 'Active', sortOrder: 8 }
  ],
