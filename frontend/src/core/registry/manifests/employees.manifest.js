...
export const EMPLOYEES_MANIFEST = {
  ...
  defaultFields: [
    ...
    { id: 'password', key: 'password', label: 'Account Login Password', type: 'password', systemField: true, required: false, searchable: false, filterable: false, sortable: false, showOnCreate: true, showOnEdit: true, showOnView: false, showOnList: false, showOnKanban: false, placeholder: 'Enter account password (min 6 chars)', sortOrder: 5.5 },
